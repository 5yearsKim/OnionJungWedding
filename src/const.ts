...
export const WEDDING_DATE = dayjs.tz("2026-07-04 13:00", "Asia/Seoul")
...
export const LOCATION = "연세대학교 동문회관 그랜드홀"
export const LOCATION_ADDRESS = "서울시 서대문구 연세로 50, 연세대 동문회관 3층"
...
export const BRIDE_FULLNAME = "유정"
